...
namespace API.Database
{
    public class Adding : Main
    {
        ...
        public void add_task(int id, int id2, int id3, int id4, int id5, CultureInfo id6, CultureInfo id7, CultureInfo id8, string id9)
        {
            ...
            {
                using (_command = new SqlCommand(sqlExpression, connection))
                {
                    connection.Open();
                    ...
                    _command.Parameters.Add(nameParam2);
                    _command.Parameters.Add(nameParam3);
                    _command.Parameters.Add(nameParam4);
                    _command.Parameters.Add(nameParam5);
                    _command.Parameters.Add(nameParam6);
                    _command.Parameters.Add(nameParam7);
                    _command.Parameters.Add(nameParam8);
                    _command.Parameters.Add(nameParam9);
